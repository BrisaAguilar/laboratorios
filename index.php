		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> TEC<span>NM</span>
							<p class="logo_w3l_agile_caption">CAMPUS COMITAN</p>
						</a></h1>
				</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>Tecnologico<span>Comitan</span></h4>
					<img src="images/1.jpg" alt=" " class="img-responsive">
					<h5></h5>
					<p>Aparta un salon de laboratorio desde la comodidad de tu casa o donde quiera,
						siendo parte del tecnologico</p>
				</div>
			</div>
		</div>
	</div>
...
E</h4>
	...
	<div class="plans-section" id="rooms">
		<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Laboratorios</h3>
			<div class="priceing-table-main">
				<div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
							<img src="images/r1.jpg" alt=" " class="img-responsive" />
							<h4>Laboratorio de ingles</h4>
						</div>
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>$</span>320</h3>
								<a href="admin/reservation.php?lab=ingles"> Apartalo ya
								</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>$</span>220</h3>
								<a href="admin/reservation.php?lab=redes">Apartar</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>$</span>180</h3>
								<a href="admin/reservation.php">Apartar</a>
							</div>
						</div>
					</div>
				</div>
