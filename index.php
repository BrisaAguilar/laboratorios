		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> TEC<span>NM</span><p class="logo_w3l_agile_caption">CAMPUS COMITAN</p></a></h1>
				</div>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>$</span>320</h3>						
								<a href="admin/reservation.php" >	Apartalo ya
</a>
							</div>
						</div>
					</div>
